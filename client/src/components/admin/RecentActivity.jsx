        ...
        {activities.length === 0 ? (
          ...
          <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
            {activities.map((activity, index) => (
              <div key={index} className="flex items-start space-x-4 pb-4 border-b border-gray-100 last:border-b-0 hover:bg-linear-to-r hover:from-gray-50 hover:to-orange-50 -mx-3 px-3 py-3 rounded-xl transition-all group/item">
                <div className={`w-3 h-3 rounded-full mt-1.5 shadow-lg ${
                  activity.type === 'success' ? 'bg-linear-to-br from-green-400 to-emerald-500 shadow-green-500/50' :
                  activity.type === 'warning' ? 'bg-linear-to-br from-orange-400 to-amber-500 shadow-orange-500/50' :
                  activity.type === 'error' ? 'bg-linear-to-br from-red-400 to-rose-500 shadow-red-500/50' :
