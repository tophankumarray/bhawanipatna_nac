      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-2xl max-h-[92vh] overflow-y-auto border border-gray-100">
        ...
        <form onSubmit={onSubmit} className="p-5 sm:p-8 space-y-5 sm:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3 pt-5 sm:pt-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              className="w-full sm:w-auto px-5 sm:px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-xl font-semibold hover:from-emerald-700 hover:to-teal-700 shadow-lg flex items-center justify-center gap-2"
            >
              Submit Record
            </button>
          </div>
    ...
    <div className="h-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-8 sm:mb-10">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-xl p-6 sm:p-7 text-white">
            <p className="text-blue-100 text-sm font-semibold mb-2">
              Total Machinery Defects
            </p>
            <p className="text-4xl sm:text-5xl font-black">{totalRecords}</p>
          </div>

          <div className="bg-gradient-to-br from-yellow-500 to-orange-500 rounded-2xl shadow-xl p-6 sm:p-7 text-white">
            <p className="text-yellow-100 text-sm font-semibold mb-2">
              Repairing Started
            </p>
            <p className="text-4xl sm:text-5xl font-black">{pendingRecords}</p>
          </div>

          <div className="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl shadow-xl p-6 sm:p-7 text-white">
            <p className="text-indigo-100 text-sm font-semibold mb-2">
              Repairing In Progress
            </p>
            <p className="text-4xl sm:text-5xl font-black">{inProgressRecords}</p>
          </div>

          <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-xl p-6 sm:p-7 text-white">
            <p className="text-emerald-100 text-sm font-semibold mb-2">
              Repaired
            </p>
            <p className="text-4xl sm:text-5xl font-black">{resolvedRecords}</p>
          </div>
        </div>
