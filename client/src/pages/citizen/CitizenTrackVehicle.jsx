    ...
    try {
      ...
      const mockData = [
        ...
        },
        {
          ...
          type: 'compactor',
          status: 'stopped',
          location: { lat: 20.289, lng: 85.8156 },
          speed: 0,
          assignedWard: 'Ward 7',
                ...
                >
                  <Popup>
                    <div className="p-2">
                      ...
                      <p className="text-sm text-gray-600">
                        📍 Location: {vehicle.location.lat.toFixed(4)},{' '}
            ...
            <div className="p-6">
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <span
                        ...
                        ).bg} text-white text-sm font-bold px-3 py-1 rounded-full inline-block`}
                      >
                        {selectedVehicle.status
                          .replace(/([A-Z])/g, ' $1')
                          .trim()}
                    ...
                    <div>
                      ...
                      <p className="text-base font-bold text-gray-900">
                        {selectedVehicle.location
                          ? `${selectedVehicle.location.lat.toFixed(
                              4
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div
                        ...
                        style={{
                          width: `${selectedVehicle.routeProgress}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-base font-bold text-gray-900">
                        {selectedVehicle.wasteCollected} tons
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600 font-semibold">
                      ...
                      <p className="text-base font-bold text-gray-900">
                        {selectedVehicle.targetWaste} tons
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex space-x-3 pt-4">
                  ...
                  <button
                    onClick={() =>
                      toast.info('Route history feature coming soon!')
                    }
